    ...
    this.state={
      directores:[
       // {nombre: 'Hellen García Retamoza', image:"./recursos/img/directores/helen_garcia.jpg", cargo: 'Directora de Planeación y Desarrollo', telefono:"38-84-94-70", correo:'hellen.garcia@tecmm.edu.mx', mailTo:'mailto:hellen.garcia@tecmm.edu.mx'},
        ...
        {nombre: 'Jorge Enrique López Campos', image:"./recursos/img/directores/enrique_lopez.jpg", cargo: 'Director de Tecnologías de la Información y Comunicaciones', telefono:"38-84-94-70", correo:'enrique.lopez@tecmm.edu.mx', mailTo:'mailto:enrique.lopez@tecmm.edu.mx'},
